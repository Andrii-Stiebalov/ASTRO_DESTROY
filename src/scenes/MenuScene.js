...
export class MenuScene extends Scene {
    ...
    createTitle() {
        ...
        this.title.position.set(this.game.app.view.width / 2, this.game.app.view.height * 0.2);
        ...
        subtitle.position.set(this.game.app.view.width / 2, this.game.app.view.height * 0.2 + 60);
        this.container.addChild(subtitle);
    }
    createPlayButton() {
        // Контейнер для 3D кнопки
        this.playButton = new Container();
        this.playButton.position.set(this.game.app.view.width / 2, this.game.app.view.height * 0.5);
    ...
    createCredits() {
        ...
        credits.position.set(this.game.app.view.width / 2, this.game.app.view.height * 0.8);
