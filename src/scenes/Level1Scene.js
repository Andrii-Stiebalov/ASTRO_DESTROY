...
export class Level1Scene extends Scene {
    player;
    input = new Input();
    bullets = new EntityManager(this.container);
    bossBullets = new EntityManager(this.container);
    Enemys = new EntityManager(this.container);
    bonuses = new EntityManager(this.container);
    waveManager;
    screenWidth;
    screenHeight;
    bgSprite;
        ...
        this.waveManager = new WaveManager([
            {
                ...
                pauseAfter: 120,
                createEnemy: () => {
                    const enemy = new Enemy(PIXI.Texture.WHITE, (this.screenWidth / 2) * Math.random(), -100, this.screenWidth, this.screenHeight);
                    if (Math.random() < 0.5) {
            ...
            },
            {
                ...
                pauseAfter: 280,
                createEnemy: () => {
                    const enemy = new Enemy(PIXI.Texture.WHITE, (this.screenWidth) * Math.random() + (this.screenWidth / 4), -100, this.screenWidth, this.screenHeight);
            ...
            },
            {
                ...
                createEnemy: () => {
                    const boss = new Boss(PIXI.Texture.WHITE, this.screenWidth / 2, 150, this.screenWidth, this.screenHeight, this.player);
                    boss.speed = 2;
                    ...
                    boss.events.on("bossShoot", (bossBullet) => {
                    ...
                    boss.events.on("spawnSubEnemy", (subEnemy) => {
    ...
    update(dt) {
        ...
        this.waveManager.update(dt, (enemy) => {
